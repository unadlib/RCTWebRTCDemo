(function(root, factory) {
    ...
    function WebPhone(regData, options) {
        ...
        var id = options.uuid || global.localStorage.getItem(this.uuidKey) || uuid(); //TODO Make configurable
        global.localStorage.setItem(this.uuidKey, id);
        ...
        var configuration = {
          ...
          traceSip: true,
            ...
            sessionDescriptionHandlerFactory: options.sessionDescriptionHandlerFactory,
